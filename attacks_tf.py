...
from cleverhansl2l.compat import reduce_mean, reduce_sum
from cleverhansl2l.compat import reduce_any
...
def fgm(x, preds, *args, **kwargs):
  ...
  from cleverhansl2l.attacks import fgm as logits_fgm
...
def pgd_attack(*args, **kwargs):
  ...
  from cleverhansl2l.attacks import projected_optimization
