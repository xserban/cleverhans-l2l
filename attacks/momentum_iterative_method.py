...
from cleverhansl2l.attacks.fast_gradient_method import optimize_linear
from cleverhansl2l.compat import reduce_sum, reduce_mean, softmax_cross_entropy_with_logits
