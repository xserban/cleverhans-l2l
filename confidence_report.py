...
from cleverhansl2l.attacks import MaxConfidence
from cleverhansl2l.attacks import Semantic
from cleverhansl2l.evaluation import correctness_and_confidence
from cleverhansl2l.evaluation import run_attack
from cleverhansl2l.utils import set_log_level
from cleverhansl2l.serial import load, save
...
def make_confidence_report_bundled(filepath, train_start=TRAIN_START,
  ...
  from cleverhansl2l import attack_bundling
  if callable(recipe):
    run_recipe = recipe
  else:
